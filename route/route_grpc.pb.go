...
type RouteGuide_RecordRouteClient interface {
	Send(*Point) error
	CloseAndRecv() (*RouteSummery, error)
	grpc.ClientStream
}
...
func (x *routeGuideRecordRouteClient) CloseAndRecv() (*RouteSummery, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(RouteSummery)
...
func (x *routeGuideRecommendClient) Send(m *Point) error {
	return x.ClientStream.SendMsg(m)
}
...
type RouteGuide_RecordRouteServer interface {
	SendAndClose(*RouteSummery) error
	Recv() (*Point, error)
	grpc.ServerStream
}
...
func (x *routeGuideRecordRouteServer) SendAndClose(m *RouteSummery) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *routeGuideRecommendServer) Recv() (*Point, error) {
	m := new(Point)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
